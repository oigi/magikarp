...
type CommentActionReq struct {
	...
	CommentText string `protobuf:"bytes,4,opt,name=comment_text,json=commentText,proto3" json:"comment_text,omitempty"` // 用户填写的评论内容，在action_type=1时使用
	CommentId   int64  `protobuf:"varint,5,opt,name=comment_id,json=commentId,proto3" json:"comment_id,omitempty"`      // 要删除的评论id，在action_type=2时使用
}
...
type CommentCountReq struct {
	...
	VideoId []int64 `protobuf:"varint,1,rep,packed,name=video_id,json=videoId,proto3" json:"video_id,omitempty"` // 视频id列表
}
...
type CommentCountResp struct {
	...
	StatusCode   int32           `protobuf:"varint,1,opt,name=status_code,json=statusCode,proto3" json:"status_code,omitempty"`
	StatusMsg    string          `protobuf:"bytes,2,opt,name=status_msg,json=statusMsg,proto3" json:"status_msg,omitempty"`
	CommentCount map[int64]int64 `protobuf:"bytes,3,rep,name=comment_count,json=commentCount,proto3" json:"comment_count,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 视频id和评论数
}
...
func (x *CommentCountResp) GetStatusCode() int32 {
	if x != nil {
		return x.StatusCode
	}
	return 0
...
func (x *CommentCountResp) GetStatusMsg() string {
	if x != nil {
		return x.StatusMsg
	}
	return ""
...
func (x *CommentCountResp) GetCommentCount() map[int64]int64 {
	if x != nil {
...
var file_comment_proto_rawDesc = []byte{
	...
	0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x65, 0x22, 0xa9, 0x01, 0x0a, 0x10, 0x43,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x53, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	...
	0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x22, 0x2b, 0x0a, 0x0e, 0x43,
	...
	0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22, 0x86, 0x01, 0x0a, 0x0f, 0x43, 0x6f, 0x6d,
	...
	0x74, 0x22, 0x2c, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e,
	0x74, 0x52, 0x65, 0x71, 0x12, 0x19, 0x0a, 0x08, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x03, 0x28, 0x03, 0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x22,
	0xe5, 0x01, 0x0a, 0x10, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74,
	...
	0x73, 0x4d, 0x73, 0x67, 0x12, 0x50, 0x0a, 0x0d, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x75,
	0x6e, 0x74, 0x52, 0x65, 0x73, 0x70, 0x2e, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f,
	0x75, 0x6e, 0x74, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x0c, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x1a, 0x3f, 0x0a, 0x11, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e,
	...
	,
...
var file_comment_proto_goTypes = []interface{}{
	...
	(*CommentCountReq)(nil),   // 5: comment.CommentCountReq
	(*CommentCountResp)(nil),  // 6: comment.CommentCountResp
	nil,                       // 7: comment.CommentCountResp.CommentCountEntry
	(*user.User)(nil),         // 8: user.User
}
var file_comment_proto_depIdxs = []int32{
	8, // 0: comment.Comment.user:type_name -> user.User
	0, // 1: comment.CommentListResp.comment_list:type_name -> comment.Comment
	7, // 2: comment.CommentCountResp.comment_count:type_name -> comment.CommentCountResp.CommentCountEntry
	1, // 3: comment.CommentService.CommentAction:input_type -> comment.CommentActionReq
	3, // 4: comment.CommentService.CommentList:input_type -> comment.CommentListReq
	5, // 5: comment.CommentService.CommentCount:input_type -> comment.CommentCountReq
	2, // 6: comment.CommentService.CommentAction:output_type -> comment.CommentActionResp
	4, // 7: comment.CommentService.CommentList:output_type -> comment.CommentListResp
	6, // 8: comment.CommentService.CommentCount:output_type -> comment.CommentCountResp
