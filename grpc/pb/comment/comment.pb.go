...
type CommentCountResp struct {
	...
	CommentCount map[int64]int32 `protobuf:"bytes,3,rep,name=comment_count,json=commentCount,proto3" json:"comment_count,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"` // 视频id和评论数
}
...
func (x *CommentCountResp) GetCommentCount() map[int64]int32 {
	if x != nil {
...
var file_comment_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0xdf, 0x01,
