...
func (c *commentServiceClient) CommentCount(ctx context.Context, in *CommentCountReq, opts ...grpc.CallOption) (*CommentCountResp, error) {
	out := new(CommentCountResp)
	err := c.cc.Invoke(ctx, "/comment.CommentService/CommentCount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCommentServiceServer) CommentCount(context.Context, *CommentCountReq) (*CommentCountResp, error) {
...
func _CommentService_CommentCount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/comment.CommentService/CommentCount",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).CommentCount(ctx, req.(*CommentCountReq))
	}
	return interceptor(ctx, in, info, handler)
}
