...
type FavoriteCountResp struct {
	...
	Code               int32           `protobuf:"varint,1,opt,name=code,proto3" json:"code,omitempty"`
	Msg                string          `protobuf:"bytes,2,opt,name=msg,proto3" json:"msg,omitempty"`
	VideoFavoriteCount map[int64]int32 `protobuf:"bytes,3,rep,name=video_favorite_count,json=videoFavoriteCount,proto3" json:"video_favorite_count,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (x *FavoriteCountResp) GetVideoFavoriteCount() map[int64]int32 {
	if x != nil {
